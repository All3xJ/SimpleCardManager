...
//    public TransactionDTO toDTO(String merchantName){
//        return new TransactionDTO(this.id,this.card.getId(),this.merchant.getId(),this.amount,this.dateCreated,merchantName); // merchantName lo si salva quando serve nel service
//    }
}
